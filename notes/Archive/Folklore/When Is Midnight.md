...
The American institution corresponding to the UK’s NPL as Keepers of the Atomic Clock is the National Institute of Standards’ Physical Measurement Laboratory. They too have a [FAQ about noon and midnight](https://www.nist.gov/pml/time-and-frequency-division/times-day-faqs), wherein they write (***emphasis again mine***):
...
Just please don’t ask why non-ᴀᴍ/ᴘᴍ times are **read out *as though* each hour were a hundred minutes long**, because I really don’t want to have discuss [metric timekeeping](https://en.wikipedia.org/wiki/Metric_time).